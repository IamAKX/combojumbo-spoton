                  ...
                  : () {
                      if (user.email.isEmpty ||
                        ...
                        CartVriablesModel cartVriablesModel = CartVriablesModel(
                          ...
                          netAmount: CartHelper.getEDiningNetAmount(
                              allChargesModel,
                              selectedPincode,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${Constants.RUPEE} ${CartHelper.getEDiningNetAmount(allChargesModel, selectedPincode, couponDiscountDetailModel).toStringAsFixed(2)}',
                        ...
                        if (allChargesModel != null)
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${Constants.RUPEE} ${allChargesModel!.EDining_Charges.toDouble().toStringAsFixed(2)}',
                              ),
                            ],
                          ),
                        if (couponDiscountDetailModel != null)
