...
class TableBookingOrderFoodModel {
  String id;
  String relid;
  String oid;
  String pro_id;
  ...
  TableBookingOrderFoodModel copyWith({
    String? id,
    String? relid,
    String? oid,
    String? pro_id,
    ...
    return TableBookingOrderFoodModel(
      id: id ?? this.id,
  ...
  factory TableBookingOrderFoodModel.fromMap(Map<String, dynamic> map) {
    return TableBookingOrderFoodModel(
      id: map['id'],
      relid: map['relid'],
      oid: map['oid'],
  ...
  bool operator ==(Object other) {
    ...
    return other is TableBookingOrderFoodModel &&
        other.id == id &&
        other.relid == relid &&
        other.oid == oid &&
        other.pro_id == pro_id &&
