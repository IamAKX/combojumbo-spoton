...
class HomeScreenIosSpecific extends StatefulWidget {
  const HomeScreenIosSpecific(this.refreshMainContainerState) : super();
  final Function() refreshMainContainerState;
  @override
  _HomeScreenIosSpecificState createState() => _HomeScreenIosSpecificState();
}

class _HomeScreenIosSpecificState extends State<HomeScreenIosSpecific> {
        ...
        : ListView(
            children: [
                        ...
                        (cjRouteModel) => InkWell(
                          onTap: () {
                            Navigator.of(context).pushNamed(
                              IOSLoginNeeded.IOS_LOGIN_NEEDED_ROUTE,
                            );
                          },
                          child: Column(
                            children: [
              ...
              SubHeading(
                title: 'Category',
                context: context,
                routePath: IOSLoginNeeded.IOS_LOGIN_NEEDED_ROUTE,
