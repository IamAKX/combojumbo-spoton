...
class RecomendedItemsIosSpecific extends StatelessWidget {
  const RecomendedItemsIosSpecific({
    Key? key,
...
class CategoryCardIosSpecific extends StatelessWidget {
  const CategoryCardIosSpecific({
    Key? key,
    required this.screenSize,
